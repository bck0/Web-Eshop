...
namespace Faltynek.Eshop.Web.Areas.Admin.Controllers
{
    ...
    public class OrderItemsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductID"] = new SelectList(_context.Product, "ID", "ImageSource");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,OrderID,ProductID,Amount,Price")] OrderItem orderItem)
        {
            ...
            ViewData["ProductID"] = new SelectList(_context.Product, "ID", "ImageSource", orderItem.ProductID);
            return View(orderItem);
        }
